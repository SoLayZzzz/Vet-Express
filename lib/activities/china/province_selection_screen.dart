...
class ProvinceSelectionScreen extends StatelessWidget {
  ...
  Widget _buildProvinceList() {
    if (controller.filteredProvinces.isEmpty && controller.provinceSearchText.value.isNotEmpty) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            ...
            const SizedBox(height: 16),
            Text('no_provinces_found'.tr, style: const TextStyle(fontSize: 16, color: Colors.grey)),
          ],
        ),
      );
    }
