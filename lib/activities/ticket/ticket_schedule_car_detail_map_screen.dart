...
class TicketScheduleCarDetailMapScreen extends StatefulWidget {
  ...
  @override
  State<TicketScheduleCarDetailMapScreen> createState() => _TicketScheduleCarDetailMapScreenState();
}

class _TicketScheduleCarDetailMapScreenState extends State<TicketScheduleCarDetailMapScreen> {
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: IconButton(
                          ...
                          icon: Image.asset("assets/images/ic_to_map.png", height: 24),
                        ),
                      ),
                    ),
                  ],
