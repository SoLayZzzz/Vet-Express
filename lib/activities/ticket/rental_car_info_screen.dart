...
import 'package:express_vet/activities/ticket/select_rental_province_screen.dart';
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          child: TextFormField(
                              ...
                              validator: (String? value) {
                                return CheckInput().checkLength(
                                    value!, 3, 'name_is_required'.tr, 'name_at_least_3'.tr);
                              },
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: TextFormField(
                              ...
                              style: const TextStyle(fontSize: 14),
                              validator: (String? value) {
                                return CheckInput().checkLength(value!, 9,
                                    'phone_number_is_required'.tr, 'phone_number_is_incorrect'.tr);
                              },
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: TextFormField(
                              ...
                              onTap: () async {
                                await Get.to(
                                  () => const SelectRentalProvinceScreen(selectType: 'From'),
                              ...
                              validator: (String? value) {
                                return CheckInput()
                                    .checkLength(value!, 1, 'location_is_required'.tr, '');
                              },
                              decoration: Style.inputText('province_city'.tr,
                        ...
                        SizedBox(
                          width: MediaQuery.of(context).size.width * 0.4,
                          child: TextFormField(
                              controller: desToController..text = ValueStatic.provinceRentalToName,
                              autofocus: false,
                              readOnly: true,
                              showCursor: false,
                              maxLines: null,
                              onTap: () async {
                                await Get.to(
                                  () => const SelectRentalProvinceScreen(selectType: 'To'),
                                  transition: Transition.rightToLeft,
                                  duration: const Duration(milliseconds: Constrains.duration),
                                );
                                setState(() {});
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: TextFormField(
                                ...
                                DateTime? pickedDate = await showDatePicker(
                                    ...
                                    locale: Get.locale.toString() == "km_KH"
                                        ...
                                        : Get.locale.toString() == "en_US"
                                            ? const Locale("en", "US")
                                            : const Locale("zh", "CN"),
                                    initialDate: DateFormat('yyyy-MM-dd').parse(goDate),
                              ...
                              style: const TextStyle(fontSize: 14),
                              validator: (String? value) {
                                return CheckInput().checkLength(value!, 1, 'required'.tr, '');
                              },
                              decoration: Style.inputText(goDate,
                                  iconRight: Ionicons.chevron_forward_outline)),
                        ),
                        const Spacer(),
                        Text('until'.tr),
                        ...
                        SizedBox(
                          ...
                          child: TextFormField(
                              ...
                              decoration:
                                  Style.inputText('', iconRight: Ionicons.chevron_forward_outline)),
                        ),
                      ],
                    ),
                    const SizedBox(height: 20),
                    ...
                    TextFormField(
                        ...
                        style: const TextStyle(fontSize: 14),
                        validator: (String? value) {
                          return CheckInput().checkLength(value!, 1, 'amount_is_required'.tr, '');
                        },
                        decoration: Style.inputText(
                          'amount'.tr,
                        )),
                      ...
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          if (goDate != '' &&
                            ...
                            VehicleRental().rentalSave(
                                context,
                                RentalCarInfoScreen.busId,
                                goDate,
                                backDate,
                                nameController.text,
