...
import 'package:express_vet/activities/logistic/self_service_qr_list_screen.dart';
...
class GoodsTransferHistoryScreen extends StatefulWidget {
  ...
  @override
  GoodsTransferHistoryScreenState createState() => GoodsTransferHistoryScreenState();
}
...
class GoodsTransferHistoryScreenState extends State<GoodsTransferHistoryScreen>
  ...
  void initState() {
    ...
    futureGoodsTransfer =
        GoodsTransfer().getTransferList(context, 1, 100, desFromId, desToId, type, statusId);
  }
                            ...
                            onTap: () {
                              Get.to(
                                  () => SelfServiceQRListScreen(
                                      qrCode: (data.data?.body?.data?[index].code).toString()),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                        (data.data?.body?.data?[index].senderTelephone).toString()),
                                    Text((data.data?.body?.data?[index].receiverTelephone)
                                        .toString())
                                  ],
                                ),
                                const SizedBox(height: 5),
                                ...
                                const SizedBox(height: 5),
                                Text((data.data?.body?.data?[index].destinationTo).toString()),
                                const SizedBox(height: 5),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                ...
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Text("\$${data.data?.body?.data?[index].itemValue}"),
                                    Text(
                                        "${data.data?.body?.data?[index].itemQty} ${data.data?.body?.data?[index].uomName}")
                                  ],
                                ),
                                const SizedBox(height: 5),
                                Text('date'.tr, style: const TextStyle(color: Colors.grey)),
                                const SizedBox(height: 5),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Text((data.data?.body?.data?[index].date).toString()),
                                    Text('view_qr_code'.tr,
                                ...
                                onTap: () {
                                  Get.to(
                                    () => GoodsInformationScreen(
                                        id: (data.data?.body?.data?[index].id)!.toInt()),
                                    transition: Transition.rightToLeft,
                                    duration: const Duration(milliseconds: Constrains.duration),
                                  );
                                  log("Good ID : ${(data.data?.body?.data?[index].id)!.toInt()}");
                                },
                                child: Column(
                                  children: [
                                    //* code, date
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Text("${data.data?.body?.data?[index].code}",
                                            style: const TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 15,
                                                color: AppColors.titleColor)),
                                        Text("${data.data?.body?.data?[index].date}",
                                            style: const TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 15,
                                                color: AppColors.titleColor))
                                      ...
                                      children: [
                                        Column(
                                          children: [
                                            ...
                                            Image.asset('assets/images/ic_posting.png',
                                                width: 40, height: 40)
                                          ],
                                        ),
                                        Expanded(
                                          child: Column(children: [
                                            Text(
                                                returnStatus(
                                                    (data.data?.body?.data?[index].status)!),
                                                style: const TextStyle(
                                                    fontWeight: FontWeight.bold,
                                                    fontSize: 16,
                                                    color: AppColors.secondaryColor)),
                                            Image.asset('assets/icons/icon_tracking_line.png'),
                                          ]),
                                        ),
                                        Column(
                                          children: [
                                            const SizedBox(height: 20),
                                            Image.asset('assets/images/ic_receive.png',
                                                width: 40, height: 40)
                                          ],
                                        ),
                                      ],
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text(
                                              (data.data?.body?.data?[index].destinationFromEn)
                                                  .toString(),
                                              style: const TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 15,
                                          ...
                                          const Spacer(),
                                          Text(
                                              (data.data?.body?.data?[index].destinationToEn)
                                                  .toString(),
                                              style: const TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 15,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                            (data.data?.body?.data?[index].senderTelephone)
                                                .toString(),
                                            style: const TextStyle(
                                                fontWeight: FontWeight.bold, fontSize: 14)),
                                        Text(
                                            (data.data?.body?.data?[index].receiverTelephone)
                                                .toString(),
                                            style: const TextStyle(
                                                fontWeight: FontWeight.bold, fontSize: 14))
                                      ],
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              Image.asset('assets/icons/icon_qty.png', width: 24),
                                              const SizedBox(width: 6),
                                              Text('Qty: ${(data.data?.body?.data?[index].qty).toString()}',
                                                  style: const TextStyle(fontWeight: FontWeight.bold))
                                            ],
                                          ),
                                          if ((data.data?.body?.data?[index].isSurveyReceiver)
                                                      .toString() ==
                                                  '0' &&
                                              type == 2)
                                            Row(
                                                      ...
                                                      var result = await Navigator.push(
                                                          ...
                                                          MaterialPageRoute(
                                                              builder: (context) => ReviewScreen(
                                                                    goodsTransferID: (data.data
                                                                            ?.body?.data?[index].id)
                                                                        .toString(),
                                                                    type: type.toString(),
                                                                  )));
                                                      if (result != null) {
                                                        futureGoodsTransfer = GoodsTransfer()
                                                            .getTransferList(context, 1, 100,
                                                                desFromId, desToId, type, statusId);
                                                        setState(() {});
                                                      }
                                                    },
                                                    child: Text('take_survey'.tr,
                                                        style: const TextStyle(
                                                            fontWeight: FontWeight.bold)))
                                              ],
                                            ),
                                          if ((data.data?.body?.data?[index].isSurveySender)
                                                      .toString() ==
                                                  '0' &&
                                              type == 1)
                                            Row(children: [
                                              ...
                                              InkWell(
                                                  ...
                                                  onTap: () async {
                                                    var result = await Navigator.push(
                                                        ...
                                                        MaterialPageRoute(
                                                            builder: (context) => ReviewScreen(
                                                                  goodsTransferID: (data.data?.body
                                                                          ?.data?[index].id)
                                                                      .toString(),
                                                                  type: type.toString(),
                                                                )));
        ...
        child: InkWell(
          onTap: () async {
            ...
            setState(() {
              ...
              statusId = result[2];
              futureGoodsTransfer =
                  GoodsTransfer().getTransferList(context, 1, 100, desFromId, desToId, 1, statusId);
            });
          },
          child: Container(
            width: 60,
            height: 60,
            decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(70), color: AppColors.primaryColor),
            child: const Icon(
