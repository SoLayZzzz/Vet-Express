...
class _LogisticMemberScreenState extends State<LogisticMemberScreen> {
  ...
  void initState() {
    ...
    futureMembership = Membership().getMemberShip(context);
  }
                ...
                children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Text(
                                            showInfo ? 'hide_info_card'.tr : 'see_info_card'.tr,
                                            style: TextStyle(
                                              fontSize: 14,
                  ...
                  Column(
                    ...
                    children: [
                      const SizedBox(height: 20),
                      WidgetZoom(
                        heroAnimationTag: 'vip_image_tag', // Unique tag for Hero animation
  ...
  Row view(String name, String description) {
    return Row(
      children: [
        Text(name, style: const TextStyle(fontSize: 14, color: AppColors.textColor)),
        const Text(':'),
        const SizedBox(width: 10),
        Text(description, style: const TextStyle(fontSize: 14, color: AppColors.textColor)),
      ],
    );
  }
