...
import 'package:express_vet/activities/logistic/location_detail_screen.dart';
...
class _LocationState extends State<LocationSearchScreen> {
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Text('data_not_found'.tr, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
    );
  }
