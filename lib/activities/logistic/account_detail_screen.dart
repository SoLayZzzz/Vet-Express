                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(
                                    child: Container(
                                      width: 72, // slightly smaller to create the border effect
                                      height: 72,
                                      decoration: BoxDecoration(
                                        color: Colors.white,
                                        borderRadius: BorderRadius.circular(50),
                                      ...
                                      child: Center(
                                        child: Text((selectData.data?.body?.message).toString(),
                                            style: const TextStyle(
                                  ...
                                  return Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Image.asset('assets/images/ic_card.jpg', width: 24),
                                            const SizedBox(width: 14),
                                            Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                Text((selectData
                                                        .data!.body?.data?[index].transactionNo)
                                                    .toString()),
                                                Text((selectData.data!.body?.data?[index].reference)
                                                    .toString()),
                                              ],
                                            ),
                                            const Spacer(),
                                            Text(
                                              (selectData.data!.body?.data?[index].amount)
                                                  .toString(),
                                              style: const TextStyle(
