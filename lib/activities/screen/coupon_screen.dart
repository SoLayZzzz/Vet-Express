...
import '../../models/booking/check_apply_coupon_code.dart';
...
class _SelectCouponScreenState extends State<SelectCouponScreen> {
  ...
  checkApplyCoupon(
    ...
    print("check apply coupon code ${map.toString()}");

    try {
      final response = await http
          .post(
            Uri.parse('${BaseUrl.BASE_URL_TICKET}booking/checkCoupon'),
      ...
      if (response.statusCode == 200) {
        ...
        log('This is response check coupon apply ==>> ${response.body}');
        var data = CheckPromotionCodeResponse.fromJson(
