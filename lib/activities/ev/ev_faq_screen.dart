...
import '../../controller/ev/ev_faq_controller.dart';
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text('failed_to_load_faq'.tr, style: const TextStyle(fontSize: 16, color: Colors.grey)),
          const SizedBox(height: 16),
          ElevatedButton(onPressed: faqController.refreshData, child: Text('retry'.tr)),
        ],
      ),
    );
  }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text('no_faq_available'.tr, style: const TextStyle(fontSize: 16, color: Colors.grey)),
        ],
      ),
    );
  }
      ...
      children: [
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                // Load more indicator
                if (faqController.isLoading.value && faqController.faqList.isNotEmpty)
        ...
        if (faqController.hasMore.value && !faqController.isLoading.value)
          Container(
            ...
            child: ElevatedButton(onPressed: faqController.loadMore, child: Text('load_more'.tr)),
          ),
      ],
    );
  }
