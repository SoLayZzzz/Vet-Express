...
class EvWalletScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (walletController.isLoading.value && !walletController.hasWalletData) {
          ...
          slivers: [
            ...
            SliverPersistentHeader(
              ...
              delegate: _StickyFilterDelegate(
                child: Container(color: Colors.white, child: _buildFilterChips(walletController)),
                height: 80.0,
              ),
            ),
            ...
            if (walletController.hasError.value)
              ...
              SliverFillRemaining(child: _buildEmptyState())
                ...
                walletController.searchTransactions(walletController.searchQuery.value).isEmpty)
  ...
  Widget _buildSliverHeader(BuildContext context, EvWalletController walletController) {
    return SliverAppBar(
  ...
  Widget _buildFilterChip({
    ...
    return FilterChip(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(color: isSelected ? AppColors.primaryColor : Colors.grey[300]!),
      ),
    );
  }
  ...
  Widget _buildSliverTransactionList(EvWalletController walletController) {
    final transactionsToShow =
        walletController.searchQuery.value.isEmpty
            ...
            : walletController.searchTransactions(walletController.searchQuery.value);

    return SliverList(
      delegate: SliverChildBuilderDelegate((context, index) {
        if (index == transactionsToShow.length) {
          // Load more indicator
          if (walletController.hasMoreData.value && !walletController.isLoading.value) {
      ...
      }, childCount: transactionsToShow.length + (walletController.hasMoreData.value ? 1 : 0)),
    );
  }

  Widget _buildDayTransactionSection(Group group, EvWalletController walletController) {
    ...
    return Column(
      ...
      children: [
        ...
        Column(
          children:
              group.transactions!
                  .map((transaction) => _buildTransactionItem(transaction, walletController))
                  .toList(),
        ),
  ...
  Widget _buildTransactionItem(Transaction transaction, EvWalletController walletController) {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (transaction.createdDate != null && transaction.createdDate!.isNotEmpty)
                  Text(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          Text('no_transactions'.tr, style: const TextStyle(fontSize: 18, color: Colors.grey)),
