...
import '../../controller/ev/ev_station_controller.dart';
...
class _EvAllStationScreenState extends State<EvAllStationScreen> {
  ...
  void _showProvinceFilterDialog() {
    showDialog(
      context: context,
      builder: (context) => ProvinceFilterDialog(stationController: stationController),
    );
  }
            ...
            return Stack(
              children: [
                ...
                if (stationController.searchQuery.value.isNotEmpty)
                  Positioned(
                    top: MediaQuery.of(context).size.height * 0.12,
                    left: stationController.selectedProvince.value != null ? 120 : 16,
                    child: Container(
                      padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                      decoration: BoxDecoration(
                        color: Colors.blue,
        ...
        child: AnimatedContainer(
          ...
          child: Center(
            child: AnimatedOpacity(
              duration: const Duration(milliseconds: 300),
              opacity: stationController.showFavoriteAnimation.value ? 1.0 : 0.0,
              child: Column(
                ...
                children: [
                  ...
                  AnimatedContainer(
                    ...
                    transform:
                        Matrix4.identity()
                          ..scale(stationController.showFavoriteAnimation.value ? 1.2 : 0.8),
      ...
      children: [
        ...
        Transform.scale(
          ...
          child: FloatingActionButton(
            ...
            child: Stack(
              children: [
                const Icon(Icons.filter_alt, color: AppColors.primaryColor, size: 30),
                if (stationController.selectedProvince.value != null)
                  Positioned(
                    right: 0,
                    top: 0,
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                              ...
                              child: AnimatedContainer(
                                ...
                                child: AnimatedSwitcher(
                                  ...
                                  child: Icon(
                                    ...
                                    key: ValueKey(station.isFavorite), // Important for animation
                                    color:
                                        (station.isFavorite ?? false)
                    ...
                    Row(
                      children: [
                        Icon(Icons.ev_station, size: 16, color: Colors.blueGrey[700]),
                        const SizedBox(width: 4),
                        Text(
                          "DC 1/6",
                          style: TextStyle(
                        ...
                        Icon(Icons.attach_money, size: 16, color: Colors.blueGrey[700]),
  ...
  String _calculateDistance(String? lat, String? lng) {
    ...
    if (stationController.currentPosition.value != null) {
      ...
      final distance = _calculateSimpleDistance(userLat, userLng, stationLat, stationLng);
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          ElevatedButton(onPressed: stationController.refreshData, child: Text('retry'.tr)),
        ],
      ),
    );
  }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text('no_stations_found'.tr, style: const TextStyle(fontSize: 16, color: Colors.grey)),
          const SizedBox(height: 8),
          Text('try_different_search'.tr, style: const TextStyle(fontSize: 14, color: Colors.grey)),
          const SizedBox(height: 16),
          ElevatedButton(
          ...
          children: [
            ...
            Obx(() {
              return Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      'provinces_found'.trParams({'count': _filteredProvinces.length.toString()}),
                      style: TextStyle(
                        fontSize: 12,
                    ...
                    if (_searchController.text.isNotEmpty)
                      TextButton(
                        onPressed: _clearSearch,
                        child: Text('clear_search'.tr, style: const TextStyle(fontSize: 12)),
                      ),
                  ],
                ),
              );
            ...
            Expanded(
              child: Obx(() {
                ...
                if (_filteredProvinces.isEmpty && _searchController.text.isNotEmpty) {
                  return Center(
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        const SizedBox(height: 16),
                        ElevatedButton(onPressed: _clearSearch, child: Text('clear_search'.tr)),
                      ],
                    ),
                  );
                }
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isSelected =
                        widget.stationController.selectedProvince.value?.id == province.id;
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          ...
                          style: TextStyle(
                            color:
                                isSelected ? AppColors.primaryColor.withOpacity(0.8) : Colors.grey,
                          ),
                        ),
                        trailing:
