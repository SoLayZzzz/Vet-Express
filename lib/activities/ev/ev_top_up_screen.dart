...
import 'package:express_vet/controller/ev/ev_top_up_controller.dart';
...
class EvTopUpScreen extends StatelessWidget {
  ...
  Widget _buildAmountTitle() {
    return Text('choose_amount'.tr, style: const TextStyle(color: Colors.grey, fontSize: 16));
  }
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    if (!isSelected) BoxShadow(color: Colors.grey.withOpacity(0.1), blurRadius: 2),
                  ],
                ),
                child: Text(
  ...
  Widget _buildCustomAmountLabel() {
    return Text('enter_amount'.tr, style: const TextStyle(color: Colors.grey, fontSize: 16));
  }
        ...
        return TextField(
          ...
          decoration: Style.inputText('enter_amount'.tr).copyWith(
            prefixIcon: const Padding(
              ...
              child: Text('KHR', style: TextStyle(fontSize: 16, color: AppColors.textColor)),
            ),
          ),
        );
      },
                ...
                children: [
                  ...
                  Radio<int>(
                    ...
                    fillColor: WidgetStateColor.resolveWith(
                      (states) => isSelected ? AppColors.primaryColor : AppColors.borderColor,
                    ),
                    onChanged: (value) => controller.selectPaymentMethod('ABA Pay', value ?? 1),
                  ),
                ],
              ),
            ),
      ...
      builder: (controller) {
        return SizedBox(
          ...
          child: ElevatedButton(
            onPressed: controller.isLoading.value ? null : () => controller.performTopUp(),
