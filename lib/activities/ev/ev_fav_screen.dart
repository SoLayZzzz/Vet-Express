...
class EvFavoriteScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if (stationController.isLoading.value && stationController.favoriteStations.isEmpty) {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text('no_favorites'.tr, style: const TextStyle(fontSize: 16, color: Colors.grey)),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Icon(Icons.favorite, color: Color(0xFFE65100), size: 22),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          ...
                          style: const TextStyle(
                            color: Color(0xFFE65100), // Matching the orange price in screenshot
                            fontWeight: FontWeight.bold,
                            fontSize: 12,
                          ),
                        ),
