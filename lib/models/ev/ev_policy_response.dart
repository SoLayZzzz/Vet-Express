...
EvPolicyResponse evPolicyResponseFromJson(String str) => EvPolicyResponse.fromJson(json.decode(str));

String evPolicyResponseToJson(EvPolicyResponse data) => json.encode(data.toJson());
...
class EvPolicyResponse {
  ...
  factory EvPolicyResponse.fromJson(Map<String, dynamic> json) => EvPolicyResponse(
...
class EvPolicyBody {
  ...
  factory EvPolicyBody.fromJson(Map<String, dynamic> json) => EvPolicyBody(
    ...
    data: json["data"] == null ? [] : List<EvPolicyDatum>.from(json["data"]!.map((x) => EvPolicyDatum.fromJson(x))),
  );
