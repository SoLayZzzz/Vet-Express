...
String evContactResponseToJson(EvContactResponse data) => json.encode(data.toJson());
...
class EvContactResponse {
  ...
  factory EvContactResponse.fromJson(Map<String, dynamic> json) => EvContactResponse(
    header: json["header"] == null ? null : Header.fromJson(json["header"]),
    body: json["body"] == null ? null : EvContactBody.fromJson(json["body"]),
  );
...
class EvContactBody {
  ...
  factory EvContactBody.fromJson(Map<String, dynamic> json) => EvContactBody(
    ...
    data:
        json["data"] == null
            ? []
            : List<EvContactDatum>.from(json["data"]!.map((x) => EvContactDatum.fromJson(x))),
  );
