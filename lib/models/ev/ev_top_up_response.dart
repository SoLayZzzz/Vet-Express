...
EvTopUpResponse evTopUpResponseFromJson(String str) => EvTopUpResponse.fromJson(json.decode(str));

String evTopUpResponseToJson(EvTopUpResponse data) => json.encode(data.toJson());
...
class EvTopUpResponse {
  ...
  factory EvTopUpResponse.fromJson(Map<String, dynamic> json) => EvTopUpResponse(
...
class EvTopUpBody {
  ...
  EvTopUpBody({this.status, this.message, this.transactionId, this.paymentStatus, this.data});
