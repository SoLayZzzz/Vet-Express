...
EvFaqResponse evFaqResponseFromJson(String str) => EvFaqResponse.fromJson(json.decode(str));
...
class EvFaqBody {
  ...
  factory EvFaqBody.fromJson(Map<String, dynamic> json) => EvFaqBody(
    ...
    data: json["data"] == null ? [] : List<EvFaqDatum>.from(json["data"]!.map((x) => EvFaqDatum.fromJson(x))),
  );
