...
String confirmBookingResponseToJson(ConfirmBookingResponse data) => json.encode(data.toJson());
...
class ConfirmBookingResponse {
  ...
  factory ConfirmBookingResponse.fromJson(Map<String, dynamic> json) => ConfirmBookingResponse(
...
class Body {
  ...
  factory Body.fromJson(Map<String, dynamic> json) => Body(
        ...
        orderPaymentLists: json["orderPaymentLists"] == null
            ? []
            : List<OrderPaymentList>.from(
                json["orderPaymentLists"]!.map((x) => OrderPaymentList.fromJson(x))),
        confirmBookingInformation: json["confirmBookingInformation"] == null
            ? []
            : List<ConfirmBookingInformation>.from(json["confirmBookingInformation"]!
                .map((x) => ConfirmBookingInformation.fromJson(x))),
        status: json["status"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "orderPaymentLists": orderPaymentLists == null
            ? []
            : List<dynamic>.from(orderPaymentLists!.map((x) => x.toJson())),
        "confirmBookingInformation": confirmBookingInformation == null
            ? []
            : List<dynamic>.from(confirmBookingInformation!.map((x) => x.toJson())),
        "status": status,
      };
}
...
class OrderPaymentList {
  ...
  factory OrderPaymentList.fromJson(Map<String, dynamic> json) => OrderPaymentList(
        desc: json["desc"],
        descKh: json["descKh"],
