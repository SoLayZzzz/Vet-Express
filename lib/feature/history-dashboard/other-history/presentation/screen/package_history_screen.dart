                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _item(
                              label: 'show_package'.tr,
                              value: '${models.packageCode}',
                            ),
                            _item(
                              label: 'price'.tr,
                              value: '\$${models.packagePrice}',
                            ),
                            _item(
                              label: 'issue_date'.tr,
                              value: '${models.packageDate}',
                            ),
                            _item(
                              label: 'expire_date'.tr,
                              value: '${models.packageExpired}',
                            ),
                            const Padding(
