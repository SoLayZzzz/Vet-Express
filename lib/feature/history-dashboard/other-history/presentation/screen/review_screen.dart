...
class _ReviewScreenState extends State<ReviewScreen> {
  ...
  late final GoodsTransferActionController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.find<GoodsTransferActionController>();
  }
                          ...
                          child: Padding(
                            ...
                            child: CupertinoButton(
                              ...
                              onPressed: () {
                                controller.review(
                                  context: context,
                                  body: GoodsTransferReviewRequestBody(
                                    goodsTransferId: widget.goodsTransferID,
