...
String evWalletListResponseToJson(EvWalletListResponse data) =>
...
class EvWalletListResponse {
  ...
  factory EvWalletListResponse.fromJson(
    Map<String, dynamic> json,
  ) => EvWalletListResponse(
...
class EvWalletListBody {
  ...
  factory EvWalletListBody.fromJson(Map<String, dynamic> json) =>
      EvWalletListBody(
        status: json["status"],
...
class WalletData {
  ...
  factory WalletData.fromJson(Map<String, dynamic> json) => WalletData(
    ...
    groups:
        json["groups"] == null
            ? []
            : List<TransactionGroup>.from(
              json["groups"]!.map((x) => TransactionGroup.fromJson(x)),
            ),
  );
