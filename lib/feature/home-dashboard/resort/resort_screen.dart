...
import 'presentation/binding/resort_binding.dart';
import 'presentation/controller/resort_controller.dart';
...
class ResortScreen extends GetView<ResortController> {
  const ResortScreen({super.key});

  void _ensureDependencies() {
    ResortBinding().dependencies();
  }
  ...
  Widget build(BuildContext context) {
    _ensureDependencies();
    return Obx(() {
      if (controller.state.resorts.isNotEmpty) {
  ...
  Widget _buildResortListWithData() {
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemCount: controller.state.resorts.length,
        itemBuilder: (context, index) {
          final accommodation = controller.state.resorts[index];
