...
//     return Obx(() {
//       final zooming = controller.state.isCaptureZooming;
//       return AnimatedScale(
//         scale: zooming ? 1.12 : 1.0,
...
class QRScannerOverlayPainter extends CustomPainter {
  ...
  //   return Obx(() {
  //     // Stage 2: When dynamic tracking shows detected, scale the overall preview matrix.
  //     final bool isDetected = controller.state.isQrDetected; 
  //     final bool showLaserAnimation = controller.state.isLaserActive;

  //     // Adjust dynamic dimensions depending on whether Stage 2/3 has kicked in
  //     final double dynamicCutOutSize = isDetected ? (defaultCutOut * 1.15) : defaultCutOut;
  //     final double bottomPosition =
  //         (MediaQuery.of(context).size.height + dynamicCutOutSize) / 2 + 10;
  ...
  //           ),
  //         ),
  //         // Wrapped overlay in AnimatedContainer to elegantly morph borders out 
  //         AnimatedPositioned(
  //           duration: const Duration(milliseconds: 400),
  //           curve: Curves.easeInOutCubic,
  //           top: 0, left: 0, right: 0, bottom: 0,
  ...
  //             borderWidth: 7,
  //             cutOutSize: dynamicCutOutSize,
  //             showLaser: showLaserAnimation, // Controls laser line behavior
  //           ),
  //         ),
  //         Positioned(
  //           left: 0,
